      ...
      <div className="bg-[#111] pt-28 pb-16 border-b border-[#2d6a2d]/30">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[#4a9a4a] text-xs font-bold uppercase tracking-widest">Obras Destacadas</span>
          </div>
            ...
            {obras.map((obra, i) => (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <span className="text-[#2d6a2d] font-black text-sm tracking-widest">
                ...
                <div className="w-8 h-px bg-gray-300 group-hover:bg-[#2d6a2d] mb-4 transition-colors" />
                <h3 className="text-xl font-black text-[#111] group-hover:text-[#2d6a2d] transition-colors">
                  {obra.nombre}
                </h3>
              </div>
            ))}
